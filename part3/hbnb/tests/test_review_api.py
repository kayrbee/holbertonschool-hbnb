...
class TestReviewEndpoints(unittest.TestCase):
    ...
    # <-- This section tests successful GET requests -->
    ...
    # <-- This section covers authorisation checks -->
    ...
    # <-- This section section covers validation scenarios -->
    ...
    # <-- This section covers admin CRUD operations -->
    ...
    # <-- The tests in this section may need further debugging -->
